...
FLAG_VIRTIO_DRV="-drive file=centos.iso,if=none,id=drive-ide0-1-0,readonly=on,format=raw,serial= -device ide-cd,bus=ide.1,unit=0,drive=drive-ide0-1-0,id=ide0-1-0 \
-drive file=cluster-1-$1.raw,if=none,id=drive-virtio-disk0,format=raw,serial=8ca429f5-285d-41b6-8ce9-ec74a519e3b9,cache=none,werror=stop,rerror=stop,aio=threads -device virtio-blk-pci,scsi=off,bus=pci.0,addr=0x7,drive=drive-virtio-disk0,id=virtio-disk0,bootindex=1
-drive file=gluster-1-$1.raw,if=none,id=drive-virtio-disk1,format=raw,serial=8ca429f5-285d-41b6-8ce9-ec74a519e3b9,cache=none,werror=stop,rerror=stop,aio=threads -device virtio-blk-pci,scsi=off,bus=pci.0,addr=0x8,drive=drive-virtio-disk1,id=virtio-disk1"
...
FLAG_BALLOON="-device virtio-balloon-pci,id=balloon0,bus=pci.0,addr=0x9"
